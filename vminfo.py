...
def cmdArgsParser():
    ...
    parser.add_argument('-p', '--procvm', help='Process list on vmware', action="store_true")
    parser.add_argument('-o', '--poweron', help='PowerON vm with PID', action="store") 
    parser.add_argument('-q', '--quitvmrx', dest='offvm', help='PowerOFF vm with Regex', action="store") 
    parser.add_argument('-r', '--runvm', help='PowerON vm with Regex', action="store")  
    parser.add_argument('-i', '--ip', help='IP Esxi Host', action="store",  dest="host", default='192.168.180.46')
